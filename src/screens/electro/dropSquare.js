...
function SmallSquare(props) {
    const [imgUrl, setImgUrl] = React.useState( (props.imgUrl===undefined || props.imgUrl.qimg===undefined)?imgUrlimg:'https://backend.bhashasangam.in/getImage/?imgName='+props.imgUrl.aimg)
      const tileStyle = {
        width: '100%',
        height: '100%',
        transiion:'2s ease',
